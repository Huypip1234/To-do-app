...
>(({ element, myKey }, ref) => {
	...
	return (
		<>
			<li
				ref={ref}
				className="text-lg flex justify-between items-center break-all mr-4 mb-2 ml-2"
			>
				<div>
					<input
						type="checkbox"
				...
				<div className={`w-48 ssm:w-56 sm:w-64 ${check ? "line-through" : ""}`}>
					{element}
				</div>
				<div
					onClick={() => {
